...
public class VisionObjectDataPixy2Listener implements TableEntryListener {
	...
	public VisionObjectDataPixy2Listener(BlockingQueue<VisionData> queue) {
	...
	public void valueChanged(NetworkTable table, java.lang.String key, NetworkTableEntry entry, NetworkTableValue value,
		...
		if (saveValue) { // save object data if enabled
			// Data from Network Table goes here from entry "pixy2objdata"
	...
	// Set the object save mode pixy2
